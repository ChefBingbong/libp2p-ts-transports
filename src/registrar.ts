...
import type { IdentifyResult, Libp2pEvents, Logger, PeerId, PeerStore, PeerUpdate, Topology, TypedEventTarget } from "@libp2p/interface";
import type { Registrar, StreamHandler, StreamHandlerOptions, StreamHandlerRecord } from "@libp2p/interface-internal";
