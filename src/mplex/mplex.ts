import { MuxerClosedError, TooManyOutboundProtocolStreamsError } from "@libp2p/interface";
...
import { type Message, MessageTypeNames, MessageTypes } from "./message-types.js";
import { type MplexStream, createStream } from "./stream.js";
