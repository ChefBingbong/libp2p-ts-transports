...
import type { Ed25519PeerId, Ed25519PrivateKey, Ed25519PublicKey, PeerId, PrivateKey, PublicKey, RSAPeerId, RSAPrivateKey, RSAPublicKey, Secp256k1PeerId, Secp256k1PrivateKey, Secp256k1PublicKey, URLPeerId } from '@libp2p/interface'
...
import { Ed25519PeerId as Ed25519PeerIdClass, RSAPeerId as RSAPeerIdClass, Secp256k1PeerId as Secp256k1PeerIdClass, URLPeerId as URLPeerIdClass } from './peer-id'
