...
import type {
	Ed25519PeerId as Ed25519PeerIdInterface,
	Ed25519PublicKey,
	PeerId,
	PeerIdType,
	PublicKey,
	RSAPeerId as RSAPeerIdInterface,
	RSAPublicKey,
	Secp256k1PeerId as Secp256k1PeerIdInterface,
	Secp256k1PublicKey,
	URLPeerId as URLPeerIdInterface,
...
export class RSAPeerId extends PeerIdImpl<0x12> implements RSAPeerIdInterface {
	...
	public declare readonly publicKey?: RSAPublicKey;
...
export class Ed25519PeerId extends PeerIdImpl<0x0> implements Ed25519PeerIdInterface {
	...
	public declare readonly publicKey: Ed25519PublicKey;
