...
import type { Ed25519PeerId as Ed25519PeerIdInterface, Ed25519PublicKey, PeerId, PeerIdType, PublicKey, RSAPeerId as RSAPeerIdInterface, RSAPublicKey, Secp256k1PeerId as Secp256k1PeerIdInterface, Secp256k1PublicKey, URLPeerId as URLPeerIdInterface } from '@libp2p/interface'
...
export class RSAPeerId extends PeerIdImpl<0x12> implements RSAPeerIdInterface {
  ...
  declare public readonly publicKey?: RSAPublicKey
...
export class Ed25519PeerId extends PeerIdImpl<0x0> implements Ed25519PeerIdInterface {
  ...
  declare public readonly publicKey: Ed25519PublicKey
...
export class Secp256k1PeerId extends PeerIdImpl<0x0> implements Secp256k1PeerIdInterface {
  ...
  declare public readonly publicKey: Secp256k1PublicKey
